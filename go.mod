...
require (
	...
	// lestrrat-go/jwx update is snapshot because required fix is not yet released
	github.com/lestrrat-go/jwx v1.0.6-0.20201127121120-26218808f029 // indirect
	...
	github.com/nuts-foundation/nuts-network v0.15.2-0.20201104144024-9aafdd197cb2
