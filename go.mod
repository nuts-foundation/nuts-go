...
require (
	...
	github.com/nuts-foundation/nuts-auth v0.0.2-0.20191209132458-971f71d4701d
	github.com/nuts-foundation/nuts-consent-logic v0.0.0-20191210151106-7b74a08e55af
