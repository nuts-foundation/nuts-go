...
echo "------------------------------------"
# Register Vendor A
docker-compose exec -e NUTS_MODE=cli nodeA nuts crypto selfsign-vendor-cert "Vendor A" /opt/nuts/keys/vendor_certificate.pem
docker-compose exec -e NUTS_MODE=cli nodeA nuts registry register-vendor /opt/nuts/keys/vendor_certificate.pem
